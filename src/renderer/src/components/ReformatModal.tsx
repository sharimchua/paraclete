            ...
            <div className="card" style={{
                ...
                <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        <label style={{ fontSize: '0.75rem', textTransform: 'uppercase', color: 'var(--text-muted)', fontWeight: 600 }}>Target Selection</label>
                        <div style={{ 
                            padding: '12px', 
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        <label style={{ fontSize: '0.75rem', textTransform: 'uppercase', color: 'var(--text-muted)', fontWeight: 600 }}>Your Instruction</label>
                        <textarea 
                            autoFocus
                            placeholder="e.g. 'Make this section more concise', 'Turn this into a bulleted list', 'Explain this for a layperson'..."
                            value={prompt}
                            onChange={(e) => setPrompt(e.target.value)}
                            onKeyDown={(e) => { if (e.key === 'Enter' && !e.shiftKey) handleReformat(); }}
                            style={{
                                width: '100%',
                                height: '80px',
                                padding: '12px',
                    ...
                    {result && (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                            <label style={{ fontSize: '0.75rem', textTransform: 'uppercase', color: 'var(--primary)', fontWeight: 600 }}>Paraclete Proposal</label>
                            <div style={{ 
                                padding: '16px', 
