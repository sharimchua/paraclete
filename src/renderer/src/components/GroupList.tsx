            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px' }}>
                {groups.length === 0 ? (
                    <div className="card" style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '48px' }}>
                        <p style={{ color: 'var(--text-secondary)' }}>No groups found. Manage your people by groups.</p>
                    </div>
                ) : (
                    groups.map(group => (
            ...
            {showCreateModal && (
                <div className="modal-overlay">
                    <div className="modal-content card" style={{ width: '400px' }}>
                        ...
                        <form onSubmit={handleCreateGroup} style={{ marginTop: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            <div>
