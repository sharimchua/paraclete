...
const TagSelectionModal: React.FC<Props> = ({ onClose, onSelect, existingTagIds, title }) => {
    ...
    return (
        <div className="modal-overlay">
            <div className="modal-content card" style={{ width: '400px', maxHeight: '80vh', display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    {loading ? (
                        <p style={{ textAlign: 'center', padding: '20px', color: 'var(--text-secondary)' }}>Loading tags...</p>
                        ...
                        filteredTags.map(tag => (
                            ...
                            >
                                <span>
                                    {tag.key && <span style={{ color: 'var(--text-muted)', marginRight: '4px' }}>{tag.key}:</span>}
