...
const GroupProfile: React.FC<Props> = ({
  groupId,
  onBack,
  onSelectPerson,
  onSelectNote,
  ...
  const availablePersons = allPersons.filter(
    (p) => !(group.members || []).some((m) => m.id === p.id)
  )
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: '1.25rem', fontWeight: 700, color: '#fbbf24' }}>
                    {group.aggregated_message_count || 0}
                  </div>
                </div>
                <div>
                  <div
            ...
            >
              ...
              {group.persona ? (
                ...
                <span
                  style={{ fontSize: '0.8rem', fontStyle: 'italic', color: 'var(--text-muted)' }}
                >
                  Core Default
                </span>
              )}
                ...
                >
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      ...
                      {member.latest_note_date &&
                        new Date().getTime() - new Date(member.latest_note_date).getTime() <=
                          7 * 24 * 60 * 60 * 1000 && (
                          <span
                            style={{
                              width: '6px',
                    ...
                    <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginTop: '4px' }}>
                      {member.contact_method || 'No contact'}
                    </p>
                    ...
                    <div style={{ display: 'flex', gap: '16px', marginTop: '12px' }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <span style={{ fontSize: '0.85rem', fontWeight: 600 }}>
                          {member.latest_note_date ? String(member.latest_note_date) : 'Never'}
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            {groupNotes.length === 0 ? (
              <div className="card" style={{ textAlign: 'center', padding: '40px' }}>
                <p style={{ color: 'var(--text-muted)' }}>
                  No notes linked specifically to this group.
                </p>
              </div>
            ) : (
