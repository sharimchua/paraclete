  ...
  const handleGenerateDraft = useCallback(async (): Promise<void> => {
    ...
    if (message.draft_text && message.draft_text.trim().length > 0) {
      const confirmOverwrite = window.confirm(
        'You already have an existing draft. Starting a new AI draft will overwrite your current progress. Do you wish to continue?'
      )
      ...
      >
            ...
            >
              ...
              <div style={{ display: 'flex', gap: '12px' }}>
                <input
                  ...
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' && feedback) handleIterate()
                  }}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          {!message.is_inbound && (
            <div
              ...
              style={{
                ...
                background: 'var(--primary-faded-more)'
              }}
            >
              <button
                className="btn-primary"
          ...
          <div
            ...
            style={{
              padding: '20px',
              borderLeft: noteContext ? '3px solid var(--primary)' : '3px solid var(--text-muted)'
            }}
          >
            <div
              style={{
          ...
          <div className="card" style={{ padding: '20px' }}>
            ...
            >
              {message.status === 'draft'
                ? 'Visible in drafts list'
                : message.status === 'sent'
                  ? 'Marked as completed engagement'
