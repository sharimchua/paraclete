...
const FrameworkAnalysisControls: React.FC<Props> = ({
  personId,
  groupId,
  personaId,
  title,
  ...
  return (
    <div
      style={{
        ...
        borderRadius: '16px',
        background:
          'linear-gradient(135deg, rgba(56, 189, 248, 0.05) 0%, rgba(56, 189, 248, 0) 100%)',
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          borderRadius: '10px',
          opacity: busy || isGlobalBusy || disabled ? 0.6 : 1
        }}
      ...
      >
        {busy
          ...
          : isGlobalBusy
            ...
            : `Analyse ${counts.total} Artifacts`}
      </button>
      <p
        style={{
          margin: 0,
