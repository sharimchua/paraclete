  ...
  const fetchReferences = useCallback(async (): Promise<void> => {
    ...
    try {
      const data = await api.get<Reference[]>(
        `/api/references/?search=${encodeURIComponent(searchTerm)}`
      )
      setReferences(data)
    } catch (err) {
          ...
          <div style={{ display: 'flex', gap: '24px', marginTop: '16px' }}>
            <button
              ...
              style={{
                ...
                border: 'none',
                borderBottom:
                  view === 'library' ? '2px solid var(--primary)' : '2px solid transparent',
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                borderBottom:
                  view === 'proposals' ? '2px solid var(--secondary)' : '2px solid transparent',
            ...
            {loading ? (
              ...
              references.map((ref) => (
                ...
                >
                  ...
                  <h3 style={{ margin: '0 0 12px 0', fontSize: '1.2rem', fontWeight: 700 }}>
                    {ref.title}
                  </h3>
                  <p
                    style={{
          ...
          {loading ? (
            ...
            >
              ...
              <p style={{ fontSize: '0.8rem' }}>
                Extract concepts from your session notes to see them here.
              </p>
            </div>
          ) : (
            proposals.map((prop) => (
                ...
                <div style={{ flex: 1, paddingRight: '24px' }}>
                  ...
                  <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                    ...
                    <span style={{ color: 'var(--primary)' }}>
                      Draft Note #{prop.source_note_id}
                    </span>
                  </div>
                </div>
        ...
        <div className="modal-overlay">
          <div className="modal-content card" style={{ maxWidth: '600px', width: '90%' }}>
            ...
            >
              ...
              >
                <button className="btn-secondary" onClick={() => setEditingRef(null)}>
                  Cancel
                </button>
