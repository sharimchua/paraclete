...
def get_topics(
    ...
    # The enrich_topic helper accesses .notes, .messages, and .reflections for each returned topic.
    # By eager loading these collections using selectinload, we reduce queries from (1 + 3N) to just 4.
