...
async def suggest_references(db: Session, req: schemas.ReferenceSuggestionRequest):
    ...
    try:
        ...
        # ⚡ Bolt Optimization: Eager load relationships to prevent N+1 queries.
        # Previously, accessing ref.embedding and ref.tags in the loop triggered 2 additional queries per reference.
        # This reduces database queries from (1 + 2N) to 3, significantly improving the performance of the similarity search.
        all_refs = (
