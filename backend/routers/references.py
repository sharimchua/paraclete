...
async def extract_references_task(note_id: int):
    ...
    try:
        ...
        existing_refs_lower = {r.title.lower() for r in existing_refs if r.title}
        existing_proposals_lower = {
            p.title.lower() for p in existing_proposals if p.title
        }
        ...
        for prop in raw_proposals:
            ...
            if title_lower in existing_refs_lower:
                print(
                    f"FORENSIC SKIP: '{prop['title']}' already exists in Reference Library."
                )
                continue
            if title_lower in existing_proposals_lower:
                print(
