...
async def extract_references_task(note_id: int):
    ...
    try:
        ...
        # Pre-compute hash sets of lowercase titles for O(1) lookups
        existing_ref_titles = {r.title.lower() for r in existing_refs}
        existing_proposal_titles = {p.title.lower() for p in existing_proposals}
        ...
        for prop in raw_proposals:
            ...
            if title_lower in existing_ref_titles:
                ...
                continue
            if title_lower in existing_proposal_titles:
                print(
