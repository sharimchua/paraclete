...
def resolve_framework_items(
    ...
    if aspects:
        ...
        resolved_items = [
            i for i in resolved_items if i.aspect.upper() in aspects_upper
        ]
    ...
    if core:
        data["core"] = [
            (
                ...
                else {"id": i.id, "aspect": i.aspect, "value": i.value}
            )
            for i in core.items
        ]
    ...
    if persona_id:
        ...
        if persona:
            data["persona"] = {
                ...
                "name": persona.name,
                "items": [
                    {"id": i.id, "aspect": i.aspect, "value": i.value}
                    for i in (persona.framework.items if persona.framework else [])
                ],
            }
                    ...
                    data["groups"].append(
                        {
                            ...
                            "items": [
                                {"id": i.id, "aspect": i.aspect, "value": i.value}
                                for i in g.custom_framework.items
                            ],
                        }
                    )
        ...
        if person:
            data["person"] = {
                ...
                "items": [
                    {"id": i.id, "aspect": i.aspect, "value": i.value}
                    for i in (
                        person.custom_framework.items if person.custom_framework else []
                    )
                ],
            }
